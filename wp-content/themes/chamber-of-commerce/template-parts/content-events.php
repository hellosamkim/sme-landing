    ...
    <div class="lg:container flex flex-col items-center justify-center md:flex md:flex-row md:min-h-[500px] relative z-10">
        <div class="container order-2 w-full py-16 md:order-1 md:w-1/2 lg:pr-10">
            <div class="content">
								...
								?> <h5 class="pb-3 text-white uppercase"><a href="/fr/evenements/"><?= esc_html__( 'Événements', 'chamber' ) ?></a> / <p class="inline opacity-50 text-gray-light"><?= get_the_title(); ?></p></h5> <?php 	
								} else {
								?> <h5 class="pb-3 text-white uppercase"><a href="/events/"><?= esc_html__( 'Events', 'chamber' ) ?></a> / <p class="inline opacity-50 text-gray-light"><?= get_the_title(); ?></p></h5> <?php 	
								}
								?>
                <?php
								if ( is_singular() ) :
...
<div id="post-<?php the_ID(); ?>" class="py-16">
	...
	<div class="container mt-20">
			...
			<div class="relative">
					<h2 class="pb-10 text-white"><?= esc_html__( 'Related Events', 'chamber' ) ?></h2>
