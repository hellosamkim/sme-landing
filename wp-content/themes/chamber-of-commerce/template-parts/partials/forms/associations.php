  ...
  <div class="hidden form-step"  data-form-step="1">
      <form action="" class=""  id="associations-1">  
          <p class="text-center"><?php _e('STEP 1 OF 5','chamber') ?></p>
          <h2 class="mb-4 font-semibold text-center" ><?php _e('Association Information','chamber') ?></h2> 
                    <input type="hidden" name="type" value="Association">

          <div  class="grid gap-10 gap-y-4"> 
              <div class="col-span-full">
                  <label class="form-label"><?php _e('Association Name','chamber') ?> <span class="text-primary">*</span></label>
              ...
              <div class="col-span-full">
                  ...
                  <input type="text" class="w-full" name="association_address_line1" />
              </div>
              <div class="col-span-full">
                  <label class="form-label"><?php _e('Address Line 2','chamber') ?></label>
                  <input type="text" class="w-full" name="association_address_line2" />
              </div>
  ...
  <div class="hidden form-step"  data-form-step="2">
        <form action="" class="step-2-form"  id="associations-2">  
...
<div class="hidden form-step"  data-form-step="3"> 
    <form action="" class=""  id="associations-3">  
        ...
        <div  class="grid gap-10 gap-y-4">  
            <div class="">
                ...
                <div id="associations-3-errors"></div>
...
<div class="hidden form-step"  data-form-step="4">
    <form action=""  class=""  id="associations-4">  
        ...
        <div  class="grid gap-10 gap-y-4">  
            <div class="">
                ...
                <div id="associations-4-errors"></div>
        ...
        <div  class="grid gap-10 gap-y-4">  
            <div class="block h-full p-6 bg-white border-b-4 rounded cursor-pointer border-forest-DEFUALT">
                <div class="flex items-center mb-3 space-x-2">
                    <h4 class="mb-0"><?php _e('Association Information','chamber') ?></h4>
                    <a href="" class="text-sm font-medium underline text-primary form-go-to" go-to="1"><?php _e('Edit','chamber') ?></a>
                </div>
                <div class="space-y-1 fill-data" data-form="associations-1">
            ...
            <div class="block h-full p-6 bg-white border-b-4 rounded cursor-pointer border-forest-DEFUALT">
                ...
                <div class="space-y-1 fill-data" data-form="associations-2">
            ...
            <div class="block h-full p-6 bg-white border-b-4 rounded cursor-pointer border-forest-DEFUALT">
                ...
                <div class="space-y-1 fill-data" data-form="associations-3">
                ...
                <div class="space-y-1 fill-data" data-form="associations-4">
