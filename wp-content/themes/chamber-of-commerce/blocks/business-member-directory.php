...
acf_register_block_type(array(
    'name'              => 'business-member-directory',
    'title'             => __('Business Member Directory'),
    'render_callback'   => 'business_member_directory_cb',
    'category'          => 'chamber',
    'mode'              => 'edit',
    'supports'          => ['mode'=>false],
    'icon'              => 'star-filled',
...
function business_member_directory_cb( $block) {

// Create id attribute allowing for custom "anchor" value.
$id = 'business-member-directory-' . $block['id'];
if( !empty($block['anchor']) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'business-member-directory';
...
<div class="container flex flex-col-reverse grid-cols-12 lg:grid">
        ...
        <?php
            ...
            $form_filter[] = 'city';
            $form_filter[] = 'industry_type';
            $form_filter[] = 'account_service';

            set_query_var('post_type', 'account');
            set_query_var('form_filter', $form_filter);
            set_query_var('page_size', 5);
